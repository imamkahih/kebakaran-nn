  ...
  <div class="container">
    <div class="row justify-content-center my-4">
      <div class="col-md-8 px-0">
        <h3 class="m-0 fw-bold text-secondary">ADD NEW INCIDENT</h3>
      </div>
      <div class="col-md-8 rounded px-3 pt-3 mt-4 predict-page">
        <form action="" class="mb-4" method="POST">
          <div class="d-flex justify-content-center mb-4">
            <div class="input-group w-50 mb-4">
              <input type="date" name="tgl" class="form-control text-center fs-5" placeholder="DATE" required autofocus>
            </div>
          </div>
          ...
          <div class="d-flex text-left  justify-content-center">
            <div class="incidentBox d-flex gap-3 my-4 p-3 rounded">
              <div class="form-check">
                <input class="form-check-input" type="radio" value="0" name="incident" id="no-fire">
                <label class="form-check-label" for="no-fire">
                  <h4 class="fw-bold m-0 text-success"><i class="fab fa-envira"></i> NOT FIRE</h4>
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" value="1" name="incident" id="fire">
